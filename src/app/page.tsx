...
export default function Home() {
  return (
    <div className="w-full bg-background text-foreground">
      <section className="h-[60vh] md:h-[80vh] flex items-center justify-center text-center bg-gradient-to-br from-primary to-slate-900 dark:from-slate-300 dark:to-slate-900">
